            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  a == 0
                      ...
                      : "स्तन कैंसर के शुरुआती चेतावनी के संकेत",
              ...
              Container(
                ...
                child: Text(
                  a == 0
                      ...
                      : "लक्षण अधिक आक्रामक स्तन कैंसर के लिए विशिष्ट हैं:",
                  style: TextStyle(fontSize: 20),
                ),
              ),
              SizedBox(height: 30),
                  ...
                  children: [
                    ...
                    CustomText(
                        text: a == 0
                            ...
                            : "स्तन की त्वचा का लाल होना या खड़ा होना (नारंगी की त्वचा की तरह)",
                        value: false),
                  ],
                ),
              ),
                  ...
                  children: [
                    ...
                    CustomText(
                        text: a == 0
                            ...
                            : "एंटीबायोटिक्स के एक कोर्स के बाद लक्षण अनसुलझे",
                        value: false),
                  ],
                ),
              ),
              ...
              FlatButton(
                ...
                child: Container(
                  ...
                  child: Text(
                    a == 0 ? 'Make a Prediction' : "एक भविष्यवाणी करो",
                    style: TextStyle(
                      color: Color(0xfff1a3a1),
                      fontSize: 20,
          ...
          children: [
            if (text == 'Male' || text == "नर")
              ...
              Text(((20 - Total_female_symptoms) * 5).toString() + '%\n',
                  style: TextStyle(
                      fontSize: 30,
                      color: ((20 - Total_female_symptoms) * 5) < 30
                          ? Colors.greenAccent[200]
                          : ((((20 - Total_female_symptoms) * 5) < 50)
                              ? Colors.orangeAccent[200]
                              : Colors.redAccent[200])))
            else
              Text(
                  ...
                  style: TextStyle(
                      fontSize: 30,
                      color:
                          ((30 - Total_male_symptoms - Total_female_symptoms) *
                                      3) <
                                  30
                              ? Colors.greenAccent[200]
                              : ((((30 -
                                              Total_male_symptoms -
                                              Total_female_symptoms) *
                                          3) <
                                      50)
                                  ? Colors.orangeAccent[200]
                                  : Colors.redAccent[200]))),
